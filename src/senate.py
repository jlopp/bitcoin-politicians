...
def init_senate_search():
    ...
    try:
        ...
        # Use expect_navigation because checking the checkbox triggers navigation
        ...
        columns = ['Name', 'Office (Filer Type)', 'Report Type', 'Date Received/Filed', 'Report Link']
